...
Route::group(["middleware"=>'auth:sanctum'], function () {
    ...
    // いいねする
    Route::post('/photo/{id}/favorite', 'PhotoController@favorite')->name('photo.favorite');
    // いいね解除する
    Route::post('/photo/{id}/unfavorite', 'PhotoController@unfavorite')->name('photo.unfavorite');
});
